        ...
        <View style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
                    ...
                    <View style={{padding: 10,  flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',borderBottomWidth: 0.5,borderBottomColor: '#eee'}}>
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('HomePage', storeItems)}>
                            <View style={{flexDirection:'row', alignItems:'flex-start'}}>
                                <Text style={{fontSize: 22, fontFamily: 'Poppins_700Bold_Italic', letterSpacing:-1.8}}>DuyMinhWatch</Text>
            ...
            <ScrollView style={{flex: 1}}>
                <View style={{alignItems:'center'}}>
                    <Text style={{fontSize: 20, fontFamily: 'Poppins_600SemiBold',marginTop: 20, marginBottom: 20}}>Giỏ hàng ({bag.length})</Text>
                </View>
                    ...
                    <View key={item.id} style={{ flexDirection:'row', flex:1, paddingBottom: 20}}>
                        ...
                        <View style={{flex: 1, marginRight:50}}>
                            ...
                            <View style={{paddingTop: 4}}>
                                <Text style={{color:'#777', fontSize:12}}>Số lượng: {item.quantity}</Text>
                            </View>
                            ...
                            <View style={{ marginTop: 10, flexDirection: 'row' }}>
                                ...
                                <TouchableWithoutFeedback onPress={()=> remove(item)}>
                                    <Text style={{ marginLeft: 3, color: '#777', fontSize: 12, marginRight: 19 }}>Xóa</Text>
                                ...
                                <TouchableOpacity style={{marginRight: 15, flexDirection: 'row'}} onPress={()=>setIsFavorite(!isFavorite)} >   
                                    ...
                                    <Text style={{ marginLeft: 3, color: '#777', fontSize: 12, marginRight: 19, paddingTop: 1 }}>Yêu thích</Text>
                                </TouchableOpacity>
                ...
                <View style={{ backgroundColor: 'rgb(249,247,247)', paddingLeft: 20, paddingRight:20, paddingBottom:20 }}>
                    <View style={{paddingTop: 25}}>
                        <Text style={{fontSize: 15, fontFamily: 'Poppins_500Medium'}}>Thông tin đơn hàng</Text>
                    </View>
                    <View style={{flexDirection:'row', paddingTop:25, flex:1}}>
                        <Text style={{ color: '#777',}}>Giá: </Text>
                        <View style={{alignItems:'flex-end', flex:1}}>
                            <Text style={{ color: '#777',}}>${subtotal.toFixed(2)}</Text>
                        </View>
                    </View>
                    <View style={{flexDirection:'row', paddingTop:5}}>
                        <Text style={{ color: '#777',}}>Phí vận chuyển:</Text>
                        <View style={{alignItems:'flex-end', flex:1}}>
                            <Text style={{ color: '#777',}}>${estShipping.toFixed(2)}</Text>
                        </View>
                    </View>
                    <View style={{flexDirection:'row', paddingTop:5}}>
                        <Text style={{fontSize: 15, fontFamily: 'Poppins_500Medium'}}>TỔNG</Text>
                        <View style={{alignItems:'flex-end', flex:1}}>
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: 20, paddingTop: 10 }}>
                    ...
                    <View style={{paddingTop:5}}>
                        <Text style={{color:"rgb(96,96,96)"}}>ĐẢM BẢO TÍNH XÁC THỰC</Text>
                    </View>
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: 20, paddingTop: 20 }}>
                    ...
                    <View style={{paddingTop:5}}>
                        <Text style={{color:"rgb(96,96,96)"}}>GIAO HÀNG NHANH CHONG</Text>
                    </View>
                    <View style={{alignItems:'flex-end', flex:1, paddingTop:5}}>
                        <Text style={{color:'rgb(145,14,27)', fontSize: 20}}>+</Text>
                    </View>
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: 20, paddingTop: 20 }}>
                    ...
                    <View style={{paddingTop:5, paddingBottom:35}}>
                        <Text style={{color:"rgb(96,96,96)"}}>CHẤP NHẬN TRẢ HÀNG</Text>
                    </View>
                    <View style={{alignItems:'flex-end', flex:1, paddingTop:5}}>
                        <Text style={{color:'rgb(145,14,27)', fontSize: 20}}>+</Text>
                    </View>
            ...
            <View style={{paddingTop:15, alignItems:'center', borderTopWidth:1, borderColor:'#eee'}}>
                <Text style={{color:"rgb(96,96,96)", fontSize:11}}>Đã bao gồm phí vận chuyển</Text>
            </View>
            ...
            <View style={{ marginHorizontal: 8, alignContent: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 15 }}>
                    ...
                    <TouchableOpacity onPress={()=>navigation.navigate('CheckOut')} style={{ backgroundColor: 'rgb(145,14,27)', flex: 1, marginRight: 5, padding: 10, alignItems: 'center' }}>
                        <Text style={{ color: '#fff', fontSize: 15, fontWeight: 'bold' }}>THANH TOÁN</Text>
                        <Text style={{ color: '#fff', paddingTop:2, fontSize:13, fontWeight:'bold' }}>${total.toFixed(2)}</Text>
                    </TouchableOpacity>

                    
                    <TouchableOpacity style={{ backgroundColor: '#000', flex: 1, alignItems:'center',}}>
                        <View>
                            <Text style={{ color: '#fff', paddingRight: 3, fontSize: 15 }}>Thanh toán bằng</Text>
                        </View>
                        <View>
